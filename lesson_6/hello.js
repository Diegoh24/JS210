// "use strict";
// // example of a pragma, a language construct that tells a compiler, interpreter, or other
// // translator to process code in a different way
// // enabled for the rest of scope
...
function shuffle(deck) {
  for (let counter = 0; counter < Number('0400'); counter += 1) {
